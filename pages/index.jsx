...
export default function Index() {
  ...
  return (
    <>
      ...
      Apexa is a multipurpose bot for your discord server with Moderation, Fun, Economy, Utility, Welcomer etc... features. 
	  </p>
...
Vote Apexa</a>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-12 lg:gap-y-0 lg:gap-x-12 py-24">
          <div className="col-span-4">
            <p className="text-white text-4xl font-bold" dangerouslySetInnerHTML={{ __html:"Apexa" }} />
            ...
            <a href="https://dsc.gg/apexa" className={"mt-10 flex items-center px-4 justify-center gap-x-2 shadow-lg shadow-amber-600/20 cursor-pointer rounded-xl py-4 font-medium bg-gradient-to-r from-amber-700 to-amber-500 hover:opacity-80 transition duration-200 text-white"}>
              <i className="fab fa-discord mr-2" />Invite Apexa
            </a>
          </div>
          ...
          <div className="col-span-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div>
                <div className="text-white">
                  ...
                  <p className="text-gray-500 line-clamp-4">Apexa is a multipurpose bot for your discord server with Moderation, Fun, Welcomer, Economy, Utility etc... features.</p>
                </div>
              </div>
              <div>
                <div className="text-white">
                  <p className="text-xl font-semibold mt-5"><i className={`fa fa-shield text-2xl text-amber-500`} /> Security</p>
                  <p className="text-gray-500 line-clamp-4">An safe bot that you can browse and help us develop.</p>
                </div>
              </div>
              <div>
                <div className="text-white">
      ...
      <div className="flex flex-row w-full h-auto lg:h-56 my-14 lg:my-40 bg-gradient-to-br lg:px-30 from-neutral-900/90 flex items-center justify-start to-neutral-900/50 rounded-lg p-1 shadow-md">
              <>
                <div className="lg:mx-4 lg:p-8 py-4 lg:py-16 flex items-center justify-center flex-col text-center w-full lg:w-auto lg:text-left lg:flex-none">
                  <img src="https://media.discordapp.net/attachments/1017389436541075520/1105157610690334851/IMG_20230508_211107.jpg"  width="256" className="lg:hidden rounded-xl mb-5 shadow-xl shadow-black" />
